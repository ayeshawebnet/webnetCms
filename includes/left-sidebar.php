    ...
    <div data-simplebar class="h-100">
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="table.php" class="waves-effect">
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                ...
                                <li><a target="_self" href="layouts-compact-sidebar.html">Compact Sidebar</a></li>
                                <li><a target="_self" href="layouts-icon-sidebar.html">Icon Sidebar</a></li>
                                <li><a target="_self" href="layouts-boxed.html">Boxed Layout</a></li>
                                <li><a target="_self" href="layouts-preloader.html">Preloader</a></li>
                                <li><a target="_self" href="layouts-colored-sidebar.html">Colored Sidebar</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                ...
                                <li><a target="_self" href="layouts-hori-topbar-dark.html">Topbar Dark</a></li>
                                <li><a target="_self" href="layouts-hori-preloader.html">Preloader</a></li>
                                <li><a target="_self" href="layouts-hori-boxed-width.html">Boxed Layout</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>

...
!function ($) {
    ...
    var MorrisCharts = function () {
        ...
        MorrisCharts.prototype.init = function () {
            ...
            this.createLineChart('morris-line-example', $data, 'y', ['a', 'b'], ['views', 'vistors'], ['#39a8c6', '#a500ce']);
            ...
            this.createDonutChart('morris-donut-example', $donutData, ['#000', '#000', '#000']);
            ...
            this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b'], ['Series A', 'Series B'],  ['#000', '#000']);
